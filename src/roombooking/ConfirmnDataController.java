...
public class ConfirmnDataController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        CheckOutLabel.setText(RoomBookingController.Date_TO_LocalDate(reservation.getRoom().getCheck_Out_Date()) + "");
        CheckInLabel.setText(RoomBookingController.Date_TO_LocalDate(reservation.getRoom().getCheck_In_Date()) + "");
